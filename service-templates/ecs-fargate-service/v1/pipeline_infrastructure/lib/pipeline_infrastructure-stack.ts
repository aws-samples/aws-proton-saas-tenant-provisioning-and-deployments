...
export class PipelineInfrastructureStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: cdk.StackProps) {
    ...
    const ecr_repo = new ecr.Repository(this, service_name, {
    ...
    const deploymentstateMachine = new stepfunctions.CfnStateMachine(this, 'DeploymentCfnStateMachine', {
      ...
      stateMachineName: service_name + '-deployment-pipeline',
    ...
    const stateMachine = StateMachine.fromStateMachineName(this, 'DeploymentStateMachine', service_name + '-deployment-pipeline');
